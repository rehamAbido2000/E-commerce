...
$('.featurd_list li').click(function(){
  ...
  $('#deals_featured .items-sections > div ').hide();
  
  $($(this).data('content')).fadeIn(500).css('display','flex');
});
// deals_featured , New_Arrival , best_seller 
$('.featurd_list1 li').click(function(){

  $(this).addClass('active').siblings().removeClass('active');

  $('#New_Arrival .items-sections > div').hide();
  
  $($(this).data('content')).fadeIn(500).css('display','flex');
});
// deals_featured , New_Arrival , best_seller 
$('.featurd_list2 li').click(function(){

  $(this).addClass('active').siblings().removeClass('active');

  $('#best_seller .items-sections > div').hide();
